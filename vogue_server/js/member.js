...
$(()=>{
   ...
   .blur(function(){ // 블러 함수 시작!!!
    ...
    // 해석 : 공백문자를 모두(g:global-전역) 찾아서 없애시오! (빈공백으로변경!)
    ...
    // val() 메서드 - input요소의 값(value)을 읽기/쓰기용
    // trim() 메서드 - 앞,뒤 공백 제거(공백만 있으면 공백제거)
    ...
    *****************************************************/
        ...
        if (!vReg(cv,cid)) { // false 일때 !(NOT연산자)로 true변경!
            ...
            /************************************************* 
                ...
                -> 보내는 값은 하나! 객체데이터임! 객체 안에 7가지 유형의 데이터를 보냄!
            *************************************************/
            $.ajax({
                // 1. 전송할페이지
            ...
            // 만약 아이디가 이미 있으면 "아이디가 사용중이거나 탈퇴한 아이디입니다."
    ...
    *****************************************/
    ...
    // action 설정 페이지로 모든 입력창의 값을
    // 전송하도록 설계되어있다!
    // 기본 서브밋 이동을 막고 우리가 검사하고 전송한다!
    $("#btnj").click(e => {
        // 호출확인!
        console.log("가입해!");
